...
function data(){
    ...
    if(element[5].value !=""){
     ...
     if(element[9].checked){skills.innerHTML="SKILLS: Java";}
     if(element[10].checked){skills.innerHTML="SKILLS: Python";}
    ...
    if(element[6].checked && element[7].checked && element[8] && element[9].checked && element[10].checked){skills.innerHTML="SKILLS: HTML,CSS,Java,Python";}
    if(element[9].checked && element[10].checked){skills.innerHTML="SKILLS: Java, Python";}
    if(element[8].checked && element[9].checked && element[10].checked){skills.innerHTML="SKILLS: Js,Java, Python";}
